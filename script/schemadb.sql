...
-- ===========================================
-- TABLE: item (produk milik penjual)
-- ===========================================
CREATE TABLE public.item (
  id_item varchar PRIMARY KEY,
  nama_item varchar NOT NULL,
  harga_item numeric(12,2) NOT NULL,
  id_toko uuid REFERENCES public.users(id_user), -- harus user role PENJUAL
  image varchar
);

-- ===========================================
-- TABLE: meja (daftar meja di restoran)
-- ===========================================
...
-- ===========================================
-- TABLE: sesi_pemesanan (sesi per meja)
-- ===========================================
...
-- ===========================================
-- TABLE: antrian_order (detail item dalam transaksi)
-- ===========================================
